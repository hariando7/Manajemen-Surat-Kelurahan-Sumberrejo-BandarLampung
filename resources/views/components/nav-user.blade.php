            ...
            <ul class="flex flex-col font-medium mt-4 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-transparent lg:items-center">
                <li>
                    <div class="relative">
                        ...
                        <input type="text" id="search-navbar" class="block w-full ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500" placeholder="Search anything....">
                    </div>
                </li>
                <li>
                    <div class="text-white hover:text-[#2B2A4C] flex">
                        <button id="dropdownNavbarLink" data-dropdown-toggle="profil" class="block py-2 px-3 md:p-0 text-black lg:text-white bg-white rounded md:bg-transparent hover:text-[#2B2A4C]">Profil
                            Desa
                        </button>
                        <svg class="w-2.5 h-2.5 ms-2.5 flex item-center justify-center m-auto" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4" />
                        </svg>
                    </div>
                    <!-- Dropdown menu -->
                    <div id="profil" class="z-10 hidden font-normal bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 dark:divide-gray-600">
                ...
                <li>
                    <div class="text-white hover:text-[#2B2A4C] flex">
                        <button id="dropdownNavbarLink" data-dropdown-toggle="layanan" class="block py-2 px-3 md:p-0 text-black lg:text-white bg-white rounded md:bg-transparent hover:text-[#2B2A4C]">Layanan
                        </button>
                        <svg class="w-2.5 h-2.5 ms-2.5 flex item-center justify-center m-auto" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4" />
                        </svg>
                    ...
                    <div id="layanan" class="z-10 hidden font-normal bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 dark:divide-gray-600">
                        <ul class="py-2 text-sm text-white bg-[#D72323]" aria-labelledby="dropdownLargeButton">
                            ...
                            <li>
                                <a href="/layanan-pengajuan-dokumen" class="block px-4 py-2 hover:bg-[#2B2A4C]">Pengajuan
                                    Dokumen</a>
                            </li>
                            <li>
                ...
                <li>
                    <div class="text-white hover:text-[#2B2A4C] flex">
                        <button id="dropdownNavbarLink" data-dropdown-toggle="informasi" class="block py-2 px-3 md:p-0 text-black lg:text-white bg-white rounded md:bg-transparent hover:text-[#2B2A4C]">Informasi
                        </button>
                        <svg class="w-2.5 h-2.5 ms-2.5 flex item-center justify-center m-auto" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4" />
                        </svg>
                    ...
                    <!-- Dropdown menu -->
                    <div id="informasi" class="z-10 hidden font-normal bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 dark:divide-gray-600">
                        <ul class="py-2 text-sm text-white bg-[#D72323]" aria-labelledby="dropdownLargeButton">
                            <li>
                ...
                <li>
                    <a href="/galeri-foto-video" class="block py-2 px-3 md:p-0 text-black lg:text-white rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-[#2B2A4C]">Galeri</a>
                </li>
                <li>
