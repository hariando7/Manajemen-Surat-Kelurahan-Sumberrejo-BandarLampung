                            ...
                            <div>
                                ...
                                <div class="mb-2">
                                    <label for="nama-lengkap" class="block mb-2 text-sm font-medium text-gray-900">Nama
                                        Lengkap</label>
                                    <input type="name" id="nama-lengkap"
                                ...
                                <div class="mb-2 relative">
                                    <label for="tempat-lahir"
                                        ...
                                        Lahir</label>
                                    <input type="name" id="tempat-lahir" placeholder="Tempat Lahir"
                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                                        required />
                                </div>
                                <div class="mb-2 relative">
                                ...
                                <div class="mb-2 relative">
                                    ...
                                    <input type="name" id="pekerjaan" placeholder="Pekerjaan"
                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                                        required />
                                </div>
                                <div class="mb-2">
                                ...
                                <div class="mb-2 relative">
                                    <label for="alamat-sesuai-kk"
                                        ...
                                        Sesuai KK</label>
                                    <input type="name" id="alamat-sesuai-kk" placeholder="Alamat Sesuai KK"
                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                                        required />
                                </div>
                            </div>
