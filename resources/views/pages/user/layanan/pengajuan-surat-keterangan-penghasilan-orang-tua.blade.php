                ...
                <div class="mt-10 lg:mt-20 mb-10 lg:mb-20">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-2 lg:gap-4">
                        <div class="text-black text-left">
                            <div>
                                <div class="font-bold text-black mb-5 text-lg">Data Orang Tua/Wali</div>
                                <div class="mb-2">
                                ...
                                <div class="font-bold text-black mt-10 mb-5 text-lg">Data Diri</div>
                                <div class="mb-2">
                                ...
                                <div class="mb-2 relative input-group">
                                    <style>
                                        .input-group {
                                            position: relative;
                                        }
                                    ...
                                    <label for="penghasilan-orang-tua-diri"
                                        class="block mb-2 text-sm font-medium text-gray-900">Penghasilan Orang
                                        Tua</label>
