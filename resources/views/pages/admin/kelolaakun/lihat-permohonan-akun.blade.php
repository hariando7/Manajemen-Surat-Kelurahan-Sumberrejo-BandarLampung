...
<head>
    ...
    <title>Lihat Permohonan Akun</title>
...
<body>
    ...
    <div class="pb-4 pl-4 pr-4 sm:ml-64">
        <h1 class="text-3xl font-bold pb-4">Lihat Permohonan Akun</h1>
        {{-- <div class="">
            <a href="/permohonan-akun" class="bg-[#2B2A4C] w-32 flex items-center p-1 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
