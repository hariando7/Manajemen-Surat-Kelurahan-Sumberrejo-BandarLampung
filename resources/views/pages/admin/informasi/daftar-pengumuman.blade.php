...
<body>
    ...
    <div class="pb-4 pl-4 pr-4 sm:ml-64">
        <h1 class="text-3xl font-bold pb-4">Pengumuman</h1>
        <form class="mb-2">
            <label for="default-search" class="mb-2 text-sm font-medium text-gray-900 sr-only text-black">Search</label>
            <div class="relative">
                ...
                <input type="search" id="default-search" class="w-72 p-1 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-[#DDDBDB] focus:ring-gray-500 focus:border-gray-500  placeholder-gray-400 text-black focus:ring-gray-500 focus:border-gray-500" placeholder="Search" required />
            </div>
        </form>
        <div class="flex pb-2">
            <div class="">
            ...
            <div class="absolute top-30 right-5 flex justify-between items-center rounded-md">
                <a href="#" class="bg-[#2B2A4C] w-56 flex items-center p-1 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-plus">
                        <path d="M5 12h14" />
                        <path d="M12 5v14" /></svg>
                    <span class="pl-3 font-bold flex-1 whitespace-nowrap">Tambah Pengumuman</span>
                </a>
            </div>
        </div>
